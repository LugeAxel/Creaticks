    ...
    <div class="min-h-screen bg-surface p-4 pb-28">
      <div class="max-w-screen-lg mx-auto">
        <div class="flex items-center gap-3 mb-4">
          <BackButton />
          <h1 class="text-xl font-heading font-bold text-text-heading">Antrian Tiket</h1>
        </div>
        ...
        <div class="flex gap-2 mb-4 overflow-x-auto">
          <button
            ...
            :class="activeFilter === f.key ? 'bg-teal-500 text-white' : 'bg-surface-variant text-text-muted hover:bg-surface'"
        ...
        <div v-else class="space-y-3">
          ...
          >
            ...
            <div v-if="ticket.claimed_by" class="text-xs text-amber-600 bg-amber-500/5 rounded-lg px-3 py-1.5 mb-3 ml-[52px]">
